...
var CreditCardView = BasicView.extend({
    construct:function () {
        this.parent.construct.apply(this, ["Credit Cards", "/images/creditcards.png", ComparableCategoryType.CREDIT_CARDS, [
            { id:1, name:"AMEX"},
            { id:2, name:"VISA"},
...
var CarLoanView = BasicView.extend({
    construct:function () {
        ...
        self.rawItems = [
            new CarLoan({ id:1, name:"Barclays Unsecured Loan", company:"Barclays", fixed:true, maxAmount:1000000, unsecured:true, maxLoanTerm:5, selected:false}),
            new CarLoan({ id:2, name:"Standard Chartered Car Loan", company:"Standard Chartered", fixed:true, unsecured:true, maxAmount:7000000, maxLoanTerm:10, selected:false}),
